...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116000' versionName='0.16.0'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.0 Official Dashboard'" >/dev/null
...
echo "v0.16.0 APK verified: $SIGNER"
