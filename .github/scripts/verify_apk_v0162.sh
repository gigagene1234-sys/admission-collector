...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116200' versionName='0.16.2'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.2 Jinhak Fail-Closed'" >/dev/null
...
echo "v0.16.2 APK verified: $SIGNER"
