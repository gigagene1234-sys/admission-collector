...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116300' versionName='0.16.3'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.3 High3 Recover'" >/dev/null
...
echo "v0.16.3 APK verified: $SIGNER"
