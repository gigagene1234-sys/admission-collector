...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116100' versionName='0.16.1'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.1 High3 DOM Fence'" >/dev/null
...
echo "v0.16.1 APK verified: $SIGNER"
