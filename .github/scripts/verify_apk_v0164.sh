...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116400' versionName='0.16.4'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.4 v0.9.12 Auth Baseline'" >/dev/null
...
echo "v0.16.4 APK verified: $SIGNER"
