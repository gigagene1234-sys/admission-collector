...
# Guard against regression to the known open-world default seeds.
...
# User credentials/session material must not appear in the release source tree contract.
for forbidden in ['songtaeho2008', '20081115', 'dbs6250767']:
    if forbidden in main or forbidden in policy or forbidden in topology:
        raise SystemExit('credential-like literal found in product source')
