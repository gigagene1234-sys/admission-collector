...
SIGNING = ROOT / "signing/admission-upload.keystore.enc"
...
require('versionCode = 116900', GRADLE, 'versionCode')
require('versionName = "0.16.9"', GRADLE, 'versionName')
require('Admission Hub v0.16.9 Event-Driven High3 Auth', MANIFEST, 'manifest label')
require('private const val VERSION = "0.16.9"', MAIN, 'runtime version')
require('private const val BUILD_CODE = 116900', MAIN, 'runtime build')
if not SIGNING.exists() or SIGNING.stat().st_size == 0:
    raise SystemExit('stable encrypted signing key missing')
...
print('v0.16.9 source contracts verified; v0.16.8 product logic retained')
