...
echo "$BADGING" | grep -F "package: name='com.admissionhub.collector' versionCode='116500' versionName='0.16.5'" >/dev/null
echo "$BADGING" | grep -F "application-label:'Admission Hub v0.16.5 Login Handoff + Dashboard Gates'" >/dev/null
...
echo "v0.16.5 APK verified: $SIGNER"
